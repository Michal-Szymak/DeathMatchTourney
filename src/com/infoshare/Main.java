...
public class Main {
    ...
    public static void showPopulation(){
        System.out.println("Total population: " + PopulationObserver.getPopulation());
        System.out.println("Total born: " + PopulationObserver.getTotalBorn());
        System.out.println("Total died: " + PopulationObserver.getTotalDied());
    }
}
